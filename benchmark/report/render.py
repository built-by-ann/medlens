...
def _render_limitations() -> str:
    return (
        ...
        "GGUF quantizations on local hardware; Gemini is a full-precision hosted model. Any "
        "quality difference may partly reflect quantization, not only the underlying model.\n"
