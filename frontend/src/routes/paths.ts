export const ROUTES = {
  ...
  patientCreateAnalysis: '/patients/:patientId/analyses/new',
...
export function createAnalysisPath(patientId: string | number): string {
  return `/patients/${patientId}/analyses/new`
}
